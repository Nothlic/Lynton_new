...
class Auth extends CI_Controller
{
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['role_id'] == 1) {
                        ...
                        $isNew = $this->db->get_where('contactPerson',['id' => $user['idUser']])->row_array();
                        if($isNew['isNew'] == 1) {
                        ...
                        $company = $this->db->get_where('company',['id' => $user['idCompany']])->row_array();
                        if($company['isNew'] == 1) {
                            redirect('tenant/questionnaireTenant');
                        }else {
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('lynton@gmail.com', 'Lynton Digital');
